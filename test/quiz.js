  ...
  /*
    ...
    */
    $.each(questions, function(question_index, question) {
      ...
      $countdown = $("<div>")
      .attr("class", "well")
      .html('<span id="hour" class="timer bg-success"></span> ' + 
    ...
    $.each(question.answers, function(answer_index, answer) {
      ...
      if (last_question) {
        opts.confirmButtonText = "Comprueba tus resultados";
      }
      ...
      ans_btn.on('click', function() {
        ...
        function next() {
          ...
          $progress_correct.html("Correctas: " + state.correct);
          $progress_correct.css("width", function(){
            return (state.correct / state.total) * 100 + "%";
          });

          $progress_incorrect.html("Incorrectas: " + state.incorrect);
